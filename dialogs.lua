smlua_text_utils_dialog_replace(DIALOG_000,1,6,30,200, ("Hey you! I've got to\
tell you about your\
new controls in this game!\
\
First thing is, that with\
the L button you can\
make the HUD disappear!\
\
Second important thing is,\
that, while being in\
the the chat,\
you can type 'luigi-mode\
on' or off to play\
With luigi's controls\
from the original hack.\
\
And the Final new control\
is, that with pressing\
[B] and [Z] at the same time,\
you can use luigis new\
special move.\
Sadly, Luigi is a bit more\
slippery than Mario due\
to his giant legs!"))
...
smlua_text_utils_dialog_replace(DIALOG_009,1,5,30,200, ("Hey You! It's been\
a long time since we\
last raced each other!\
We should do a race\
around this fiery\
place!\
\
...
smlua_text_utils_dialog_replace(DIALOG_013,1,5,30,200, ("You've collected 50\
coins! Do you want \
to Save?\
\
//Yes////No"))

smlua_text_utils_dialog_replace(DIALOG_014,1,4,30,200, ("Wow! Another red coin\
Star! Do you want to\
save?\
\
//You Bet//Not Now"))

smlua_text_utils_dialog_replace(DIALOG_015,1,4,30,200, ("Wow, you've collected\
nearly every star in this\
game.\
Now prepare for the \
final fight and face a\
cruel enemy!\
I pray for your\
success!"))
...
smlua_text_utils_dialog_replace(DIALOG_017,1,4,30,200, ("I'm the Big Bob-omb\
and your journey\
will end here!\
Not even Peach will\
recognize your \
...
smlua_text_utils_dialog_replace(DIALOG_019,1,2,30,200, ("Hey, you've collected\
nearly every star in this\
game.\
Now prepare for the \
final fight and face a\
...
smlua_text_utils_dialog_replace(DIALOG_031,1,5,30,200, ("Wow! How did you got\
THAT fast? I wish, i\
had your speed...\
However, guess i've\
got to hand over\
...
smlua_text_utils_dialog_replace(DIALOG_041,1,3,30,200, ("Ha! I knew, i would\
become faster than you!\
\
...
smlua_text_utils_dialog_replace(DIALOG_128,1,4,95,200, ("That was an useless \
move.\
You can't defeat me by\
throwing me out of the\
ring!"))
...
smlua_text_utils_dialog_replace(DIALOG_141,1,5,150,200, ("The first Star! \
Now you can enter\
the second Level!"))

smlua_text_utils_dialog_replace(DIALOG_142,1,5,150,200, ("The third  ★.\
Have fun in Level 3\
too!"))

smlua_text_utils_dialog_replace(DIALOG_143,1,6,150,200, ("Allready eight stars!\
