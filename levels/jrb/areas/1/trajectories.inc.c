...
const Trajectory KoopaBoB_path[] = {
	TRAJECTORY_POS(0,-11400,-726,-4603),
	TRAJECTORY_POS(1,-11247,-726,-5486),
	TRAJECTORY_POS(2,-8374,-726,-7180),
	TRAJECTORY_POS(3,-1745,-726,-7180),
	TRAJECTORY_POS(4,-1340,-726,-13846),
	TRAJECTORY_POS(5,7794,-726,-13846),
	TRAJECTORY_POS(6,7874,-186,-6698),
	TRAJECTORY_END(),
};
const Trajectory KoopaTHI_path[] = {
	...
	TRAJECTORY_POS(5,7794,-726,-13846),
	TRAJECTORY_POS(6,7874,-186,-6698),
	TRAJECTORY_POS(7,2342,-186,-6580),
	TRAJECTORY_POS(8,1948,-186,107),
	TRAJECTORY_POS(9,-3917,-726,360),
	TRAJECTORY_POS(10,-3359,-726,2861),
	TRAJECTORY_POS(11,3380,-726,3073),
	TRAJECTORY_POS(12,3565,-645,10687),
	TRAJECTORY_POS(13,4299,-491,11949),
	TRAJECTORY_POS(14,5576,-345,11797),
	TRAJECTORY_POS(15,5756,-172,10265),
	TRAJECTORY_POS(16,4582,-76,9879),
	TRAJECTORY_POS(17,206,-377,9903),
	TRAJECTORY_POS(18,-6007,-545,9087),
	TRAJECTORY_POS(19,-9342,-726,8900),
	TRAJECTORY_POS(20,-10276,-726,10278),
	TRAJECTORY_POS(21,-11135,-726,9634),
	TRAJECTORY_POS(22,-11113,-726,5238),
	TRAJECTORY_END(),
};
...
const Trajectory C4_metal_ball_path[] = {
    TRAJECTORY_POS(0, /*pos*/  4610,  -2531, -4425),
    TRAJECTORY_POS(1, /*pos*/  4878,  -2546, -4971),
    TRAJECTORY_POS(2, /*pos*/  5267,  -2531, -4950),
    TRAJECTORY_POS(3, /*pos*/  6337,  -2531, -4986),
    TRAJECTORY_POS(4, /*pos*/  7079,  -2877, -4358),
    TRAJECTORY_POS(5, /*pos*/  7460,  -2914, -1835),
    TRAJECTORY_POS(6, /*pos*/  7452,  -2914, -1605),
    TRAJECTORY_END(),
};
